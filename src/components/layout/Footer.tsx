    ...
    <footer className="bg-dark-bg text-white py-24 md:py-32 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-center gap-6 mb-12">
          ...
          {/* Email */}
          <a href="mailto:hello@fitsoc.hk" className="w-10 h-10 rounded-full border border-white/15 flex items-center justify-center text-white/50 hover:text-white hover:border-white/30 transition-colors">
